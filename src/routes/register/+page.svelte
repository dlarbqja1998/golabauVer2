            ...
            <div class="space-y-3">
                ...
                <div class="flex gap-2">
                    <select name="grade" class="flex-1 appearance-none border border-gray-300 rounded-xl px-4 py-3 bg-white outline-none focus:ring-2 focus:ring-red-200 text-sm">
                        ...
                        {#each ['1학년', '2학년', '3학년', '4학년', '대학원생', '졸업생'] as g}
                ...
                <div class="relative">
                    <select name="department" disabled={!selectedCollege} class="w-full appearance-none border border-gray-300 rounded-xl px-4 py-3 bg-white outline-none text-sm disabled:bg-gray-100 disabled:text-gray-400 focus:ring-2 focus:ring-red-200">
